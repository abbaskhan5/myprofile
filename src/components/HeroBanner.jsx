...
import man from "../assets/manm.png";
    ...
    return (
        ...
        >
            ...
            <Wrapper>
                ...
                {/* BIG HEADING START */}
                <motion.div
                    className="flex justify-center text-center mt-5 mb-10 relative"
                ...
                >
                    <div className="font-light">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Abbas Khan</span>
                    </div>
                    <div className="max-w-[510px]">
                    MERN stack developer with expertise in creating and maintaining modern websites and applications. I specialize in delivering innovative solutions to solve complex business challenges efficiently.
                    </div>
                </motion.div>
                {/* INTRO END */}
